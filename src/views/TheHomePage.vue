      ...
      <section class="relative top-32">
        ...
        >
          <div
            ...
            "
          >
            <h1>See how RealBuy App can help</h1>
          </div>
          <div
    ...
    <template v-slot:footer>
      ...
      >
        <div class="max-w-7xl md:flex md:m-auto">
          ...
          <show-hide-list-columns
            listColumnTitle="Explore RealBuy"
    ...
    const findHomeAndRental = [
      {
        ...
        title: "Buy a Home",
        description:
          "With over 1 million+ homes for sale available on the website, RealBuy App can match you with a house you will want to call home.",
        icon: "BuyAHomeIcon",
        urlId: "SalesNearMe",
      ...
      },
      {
        ...
        title: "Rent a Home",
        description:
          "With 35+ filters and custom keyword search, RealBuy App can help you easily find a home or apartment for rent that you'll love.",
        icon: "RentAHomeIcon",
        urlId: "RentsNearMe",
